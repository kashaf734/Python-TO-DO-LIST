...
button_font = Font(family="Times New Roman", size=15, weight="bold")

#"Create Task" button
add_button = tk.Button(button_frame, text="Create Task", command=add_task, font=button_font)
...
#"Update Task" button
toggle_button = tk.Button(button_frame, text="Update Task", command=toggle_task, font=button_font)
